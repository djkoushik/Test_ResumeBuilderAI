...
interface ArtifactSelectorProps {
  ...
  onMeasureResume: () => void;
  onBack: () => void;
}

const ArtifactSelector: React.FC<ArtifactSelectorProps> = ({ onSelectResume, onSelectCoverLetter, onMeasureResume, onBack }) => {
      ...
      <div className="max-w-6xl w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mx-auto px-4">
          ...
          <div
            ...
            className="bg-white dark:bg-gray-800 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 cursor-pointer p-8 border border-gray-200 dark:border-gray-700 flex flex-col h-full"
          >
          ...
          >
            <div className="flex flex-col items-center flex-grow">
              ...
              <p className="text-gray-600 dark:text-gray-300 text-center mb-6">
                Upload your existing resume and compare it against a job description to get an instant ATS score.
              </p>
              <div className="flex flex-wrap gap-2 justify-center mt-auto">
        ...
        <div className="mt-12">
          <p className="text-sm text-gray-500 dark:text-gray-400">
            All tools are powered by our advanced AI engine to ensure the best results.
          </p>
        </div>
      </div>

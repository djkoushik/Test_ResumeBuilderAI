...
import MeasureResume from './components/measure/MeasureResume';
import Footer from './components/layout/Footer';
import PrivacyPolicy from './components/legal/PrivacyPolicy';
import TermsAndConditions from './components/legal/TermsAndConditions';
import ContactPage from './components/legal/ContactPage';

type AppView = 'landing' | 'selector' | 'resume' | 'coverLetter' | 'privacy' | 'terms' | 'contact' | 'measure';
    ...
    return (
      <div className="flex flex-col min-h-screen">
        <ArtifactSelector
          ...
          onMeasureResume={() => setCurrentView('measure')}
    ...
    return (
      <div className="flex flex-col min-h-screen">
        <MeasureResume
          ...
          onGoToBuilder={handleGoToResume}
        />
        <Footer />
      </div>
    );
